    ...
    return (
        <>
            ...
            <div class="container overflow-hidden">
                <div class="row gx-5">
                    <div class="col">
                        <div class="p-3 border bg-light display-1">
                            <a class="nav-link link-secondary" href="/customerData"
                            >Customers<svg
                    ...
                    <div class="col">
                        <div class="p-3 border bg-light display-1">
                            <a class="nav-link link-secondary" href="/transferMoney"
                            >Money Handler<svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="50"
                                height="40"
            ...
            {/* <section class="section" id="section--1">
                ...
                <div class="features">
                    <img
                        src="/src/HomePage/img/digital-lazy.jpg"
                    ...
                    <img
                        src="/src/HomePage/img/grow-lazy.jpg"
                    ...
                    <img
                        src="/src/HomePage/img/card-lazy.jpg"
          ...
          "
                    >
                        ...
                        <p>
                            Do your banking in just single click
                            You can check your transaction easily by one click.
                        </p>
                    </div>
                    ...
                    <div class="operations__content operations__content--3">
                        ...
                        <p>
                            Enter the amount you'd like to withdraw,Your money will arrive in your checking account
                            in few second and be listed as from  money handler, with "transfer money"
                            somewhere in the transaction description.
                        </p>
                    </div>
                </div>
                ...
                {/* <div class="slider">
                    <div class="slide">
                        <div class="testimonial">
                            ...
                            <blockquote class="testimonial__text">
                                "It is easier to add accounts. Online transfer to
                                Singapore was really smoothand easy just like any
                                domestic transfer."
                            </blockquote>
                            <address class="testimonial__author">
                                <img src="/src/HomePage/img/user-1.jpg" alt="" class="testimonial__photo" />
                    ...
                    <div class="slide">
                        <div class="testimonial">
                            ...
                            <blockquote class="testimonial__text">
                                "The process was very simple and smooth. Remittance requires a lot of process
                                to be followed whereas in digibank it was really very simple."
                            </blockquote>
                            <address class="testimonial__author">
                                <img src="/src/HomePage/img/user-2.jpg" alt="" class="testimonial__photo" />
                    ...
                    <div class="slide">
                        <div class="testimonial">
                            ...
                            <blockquote class="testimonial__text">
                                "Bankist is better because I can do the transaction on my own and it has less
                                charges compared to others."
                            </blockquote>
                            <address class="testimonial__author">
                                <img src="/src/HomePage/img/user-3.jpg" alt="" class="testimonial__photo" />
            ...
            <footer class="footer">
                <img src="/src/HomePage/img/icon.png" alt="Logo" class="footer__logo" />
            </footer>
